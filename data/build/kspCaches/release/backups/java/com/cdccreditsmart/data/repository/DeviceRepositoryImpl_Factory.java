...
public final class DeviceRepositoryImpl_Factory implements Factory<DeviceRepositoryImpl> {
  ...
  public DeviceRepositoryImpl_Factory(Provider<DeviceApiService> deviceApiServiceProvider,
  ...
  public DeviceRepositoryImpl get() {
    return newInstance(deviceApiServiceProvider.get(), deviceBindingDaoProvider.get(), deviceStatusDaoProvider.get(), installmentDaoProvider.get(), networkErrorMapperProvider.get(), moshiProvider.get());
  }
  ...
  public static DeviceRepositoryImpl_Factory create(
    ...
    return new DeviceRepositoryImpl_Factory(Providers.asDaggerProvider(deviceApiServiceProvider), Providers.asDaggerProvider(deviceBindingDaoProvider), Providers.asDaggerProvider(deviceStatusDaoProvider), Providers.asDaggerProvider(installmentDaoProvider), Providers.asDaggerProvider(networkErrorMapperProvider), Providers.asDaggerProvider(moshiProvider));
  }
  ...
  public static DeviceRepositoryImpl_Factory create(
      ...
      Provider<InstallmentDao> installmentDaoProvider,
      Provider<NetworkErrorMapper> networkErrorMapperProvider, Provider<Moshi> moshiProvider) {
    return new DeviceRepositoryImpl_Factory(deviceApiServiceProvider, deviceBindingDaoProvider, deviceStatusDaoProvider, installmentDaoProvider, networkErrorMapperProvider, moshiProvider);
  }

  public static DeviceRepositoryImpl newInstance(DeviceApiService deviceApiService,
    ...
    return new DeviceRepositoryImpl(deviceApiService, deviceBindingDao, deviceStatusDao, installmentDao, networkErrorMapper, moshi);
  }
}
