...
public final class SecurityModule_ProvideSecurityPolicyManagerFactory implements Factory<SecurityPolicyManager> {
  ...
  public SecurityModule_ProvideSecurityPolicyManagerFactory(Provider<Context> contextProvider,
  ...
  public SecurityPolicyManager get() {
    return provideSecurityPolicyManager(contextProvider.get(), deviceOwnerManagerProvider.get(), policyExecutionServiceProvider.get(), securityPolicyRepositoryProvider.get(), offlineBlockingEngineProvider.get(), securityManagerProvider.get(), deviceDetectorProvider.get(), manufacturerCompatibilityServiceProvider.get());
  }

  public static SecurityModule_ProvideSecurityPolicyManagerFactory create(
    ...
    return new SecurityModule_ProvideSecurityPolicyManagerFactory(Providers.asDaggerProvider(contextProvider), Providers.asDaggerProvider(deviceOwnerManagerProvider), Providers.asDaggerProvider(policyExecutionServiceProvider), Providers.asDaggerProvider(securityPolicyRepositoryProvider), Providers.asDaggerProvider(offlineBlockingEngineProvider), Providers.asDaggerProvider(securityManagerProvider), Providers.asDaggerProvider(deviceDetectorProvider), Providers.asDaggerProvider(manufacturerCompatibilityServiceProvider));
  }
  ...
  public static SecurityModule_ProvideSecurityPolicyManagerFactory create(
      ...
      Provider<DeviceManufacturerDetector> deviceDetectorProvider,
      Provider<ManufacturerCompatibilityService> manufacturerCompatibilityServiceProvider) {
    return new SecurityModule_ProvideSecurityPolicyManagerFactory(contextProvider, deviceOwnerManagerProvider, policyExecutionServiceProvider, securityPolicyRepositoryProvider, offlineBlockingEngineProvider, securityManagerProvider, deviceDetectorProvider, manufacturerCompatibilityServiceProvider);
  }

  public static SecurityPolicyManager provideSecurityPolicyManager(Context context,
    ...
    return Preconditions.checkNotNullFromProvides(SecurityModule.INSTANCE.provideSecurityPolicyManager(context, deviceOwnerManager, policyExecutionService, securityPolicyRepository, offlineBlockingEngine, securityManager, deviceDetector, manufacturerCompatibilityService));
  }
}
