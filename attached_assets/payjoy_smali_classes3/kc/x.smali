...
# static fields
.field public static final f:Lkc/x;
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lkc/x$a;

    .line 3
    invoke-direct {v0}, Lkc/x$a;-><init>()V

    .line 6
    sput-object v0, Lkc/x;->g:Lrc/p;
    ...
    .line 11
    invoke-direct {v0, v1}, Lkc/x;-><init>(Z)V

    .line 14
    sput-object v0, Lkc/x;->f:Lkc/x;

    .line 16
    invoke-direct {v0}, Lkc/x;->w()V
...
.method public constructor <init>(Lrc/e;Lrc/f;)V
    ...
    .line 12
    iput-byte v0, p0, Lkc/x;->d:B

    .line 13
    iput v0, p0, Lkc/x;->e:I

    .line 14
    invoke-direct {p0}, Lkc/x;->w()V
    ...
    iput-object v5, p0, Lkc/x;->c:Ljava/util/List;

    move v4, v1

    .line 20
    :cond_3a
    iget-object v5, p0, Lkc/x;->c:Ljava/util/List;

    sget-object v6, Lkc/w;->m:Lrc/p;
    ...
    .line 24
    iget-object p2, p0, Lkc/x;->c:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lkc/x;->c:Ljava/util/List;
    ...
    iput-object p2, p0, Lkc/x;->b:Lrc/d;
    ...
    .line 30
    iget-object p1, p0, Lkc/x;->c:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lkc/x;->c:Ljava/util/List;
    ...
    iput-object p1, p0, Lkc/x;->b:Lrc/d;
...
.method public synthetic constructor <init>(Lrc/e;Lrc/f;Lkc/a;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Lkc/x;-><init>(Lrc/e;Lrc/f;)V
...
.method public synthetic constructor <init>(Lrc/h$b;Lkc/a;)V
    ...
    .line 2
    invoke-direct {p0, p1}, Lkc/x;-><init>(Lrc/h$b;)V
...
.method public constructor <init>(Z)V
    ...
    .line 8
    iput-byte p1, p0, Lkc/x;->d:B

    .line 9
    iput p1, p0, Lkc/x;->e:I
...
.method public static synthetic q(Lkc/x;)Ljava/util/List;
    .registers 1

    .line 1
    iget-object p0, p0, Lkc/x;->c:Ljava/util/List;

    .line 3
    return-object p0
.end method

.method public static synthetic r(Lkc/x;Ljava/util/List;)Ljava/util/List;
    .registers 2
...
.method public static synthetic s(Lkc/x;)Lrc/d;
    .registers 1

    .line 1
    iget-object p0, p0, Lkc/x;->b:Lrc/d;

    .line 3
    return-object p0
.end method

.method public static t()Lkc/x;
    .registers 1

    .line 1
    sget-object v0, Lkc/x;->f:Lkc/x;
...
.method private w()V
    ...
    .line 3
    iput-object v0, p0, Lkc/x;->c:Ljava/util/List;

    .line 5
    return-void
.end method

.method public static x()Lkc/x$b;
    .registers 1

    .line 1
    invoke-static {}, Lkc/x$b;->m()Lkc/x$b;
...
.method public static y(Lkc/x;)Lkc/x$b;
    .registers 2

    .line 1
    invoke-static {}, Lkc/x;->x()Lkc/x$b;

    .line 4
    move-result-object v0

    .line 5
    invoke-virtual {v0, p0}, Lkc/x$b;->u(Lkc/x;)Lkc/x$b;
...
# virtual methods
.method public A()Lkc/x$b;
    .registers 1

    .line 1
    invoke-static {p0}, Lkc/x;->y(Lkc/x;)Lkc/x$b;
...
.method public bridge synthetic b()Lrc/n$a;
    ...
    .line 1
    invoke-virtual {p0}, Lkc/x;->A()Lkc/x$b;
...
.method public d()I
    ...
    .line 9
    :goto_8
    iget-object v2, p0, Lkc/x;->c:Ljava/util/List;
    ...
    .line 34
    :cond_21
    iget-object v0, p0, Lkc/x;->b:Lrc/d;
...
.method public bridge synthetic f()Lrc/n$a;
    ...
    .line 1
    invoke-virtual {p0}, Lkc/x;->z()Lkc/x$b;
...
.method public h(Lkotlin/reflect/jvm/internal/impl/protobuf/CodedOutputStream;)V
    ...
    .line 5
    :goto_4
    iget-object v1, p0, Lkc/x;->c:Ljava/util/List;
