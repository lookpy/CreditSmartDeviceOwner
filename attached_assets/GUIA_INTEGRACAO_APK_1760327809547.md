...
3. Vendedor realiza biometria facial do cliente
4. Sistema finaliza venda e cria registro do dispositivo

CLIENTE:
5. Escaneia QR Code com câmera NATIVA do Android
6. Navegador baixa e instala APK
7. Abre o app instalado

APK:
8. Lê IMEI do hardware
9. Busca venda pendente automaticamente
10. Reivindica venda (claim-sale) e recebe JWT
11. Aguarda PDV finalizar (retry automático)
