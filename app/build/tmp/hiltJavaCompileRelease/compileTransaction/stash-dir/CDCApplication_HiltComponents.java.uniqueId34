...
import com.cdccreditsmart.data.di.DataModule;
import com.cdccreditsmart.device.di.DeviceModule;
import com.cdccreditsmart.device.offline.di.OfflineModule;
import com.cdccreditsmart.device.security.di.SecurityModule;
...
public final class CDCApplication_HiltComponents {
  private CDCApplication_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements CDCApplication_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          InstallmentsViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          InstallmentsViewModel_HiltModules.BindsModule.class,
