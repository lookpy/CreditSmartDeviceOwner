...
public abstract class Hilt_PdvFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PdvFragment_GeneratedInjector) this.generatedComponent()).injectPdvFragment(UnsafeCasts.<PdvFragment>unsafeCast(this));
    }
  }
