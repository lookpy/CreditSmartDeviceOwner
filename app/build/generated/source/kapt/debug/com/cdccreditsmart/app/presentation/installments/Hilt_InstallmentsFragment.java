 ...
 */
public abstract class Hilt_InstallmentsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InstallmentsFragment() {
    super();
  }

  Hilt_InstallmentsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InstallmentsFragment_GeneratedInjector) this.generatedComponent()).injectInstallmentsFragment(UnsafeCasts.<InstallmentsFragment>unsafeCast(this));
    }
  }
