 ...
 */
public abstract class Hilt_PaymentsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PaymentsFragment() {
    super();
  }

  Hilt_PaymentsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PaymentsFragment_GeneratedInjector) this.generatedComponent()).injectPaymentsFragment(UnsafeCasts.<PaymentsFragment>unsafeCast(this));
    }
  }
