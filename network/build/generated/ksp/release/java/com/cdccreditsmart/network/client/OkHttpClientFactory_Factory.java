...
public final class OkHttpClientFactory_Factory implements Factory<OkHttpClientFactory> {
  ...
  public OkHttpClientFactory get() {
    return newInstance(commonHeadersInterceptorProvider.get(), jwtInterceptorProvider.get(), deviceSignatureInterceptorProvider.get(), idempotencyKeyInterceptorProvider.get(), certificatePinningManagerProvider.get());
  }
  ...
  public static OkHttpClientFactory_Factory create(
      ...
      Provider<IdempotencyKeyInterceptor> idempotencyKeyInterceptorProvider,
      Provider<CertificatePinningManager> certificatePinningManagerProvider) {
    return new OkHttpClientFactory_Factory(commonHeadersInterceptorProvider, jwtInterceptorProvider, deviceSignatureInterceptorProvider, idempotencyKeyInterceptorProvider, certificatePinningManagerProvider);
  }

  public static OkHttpClientFactory newInstance(CommonHeadersInterceptor commonHeadersInterceptor,
      JwtInterceptor jwtInterceptor, DeviceSignatureInterceptor deviceSignatureInterceptor,
      IdempotencyKeyInterceptor idempotencyKeyInterceptor,
      CertificatePinningManager certificatePinningManager) {
    return new OkHttpClientFactory(commonHeadersInterceptor, jwtInterceptor, deviceSignatureInterceptor, idempotencyKeyInterceptor, certificatePinningManager);
  }
}
