...
public class CdcLocationDataJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<CdcLocationData>() {
  ...
  @Volatile
  private var constructorRef: Constructor<CdcLocationData>? = null

  public override fun toString(): String = buildString(37) {
      append("GeneratedJsonAdapter(").append("CdcLocationData").append(')') }

  public override fun fromJson(reader: JsonReader): CdcLocationData {
    ...
    if (mask0 == 0xfffffffb.toInt()) {
      ...
      val localConstructor: Constructor<CdcLocationData> = this.constructorRef ?:
          CdcLocationData::class.java.getDeclaredConstructor(Double::class.javaPrimitiveType,
  ...
  public override fun toJson(writer: JsonWriter, value_: CdcLocationData?): Unit {
    if (value_ == null) {
