...
public final class NetworkModule_ProvideOkHttpClientFactoryFactory implements Factory<OkHttpClientFactory> {
  ...
  public OkHttpClientFactory get() {
    return provideOkHttpClientFactory(commonHeadersInterceptorProvider.get(), connectivityDebugInterceptorProvider.get(), jwtInterceptorProvider.get(), deviceSignatureInterceptorProvider.get(), idempotencyKeyInterceptorProvider.get(), certificatePinningManagerProvider.get());
  }
  ...
  public static NetworkModule_ProvideOkHttpClientFactoryFactory create(
      ...
      Provider<IdempotencyKeyInterceptor> idempotencyKeyInterceptorProvider,
      Provider<CertificatePinningManager> certificatePinningManagerProvider) {
    return new NetworkModule_ProvideOkHttpClientFactoryFactory(commonHeadersInterceptorProvider, connectivityDebugInterceptorProvider, jwtInterceptorProvider, deviceSignatureInterceptorProvider, idempotencyKeyInterceptorProvider, certificatePinningManagerProvider);
  }
  ...
  public static OkHttpClientFactory provideOkHttpClientFactory(
    ...
    return Preconditions.checkNotNullFromProvides(NetworkModule.INSTANCE.provideOkHttpClientFactory(commonHeadersInterceptor, connectivityDebugInterceptor, jwtInterceptor, deviceSignatureInterceptor, idempotencyKeyInterceptor, certificatePinningManager));
  }
}
