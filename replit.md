...
### Lightweight Refactor (2025-12-10)
- **SIMPLIFIED**: AppBlockingManager now only blocks packages from backend list
...
- **INTERVAL**: 3s monitoring for security (intercepts permission screens)
