...
### 2025-12-09: Certificate Pins Reais Configurados

**Pins Configurados:**
| Tipo | Domínio | Hash SHA-256 |
|------|---------|--------------|
| Primário | picard.replit.dev | sha256/uXg7/pNSCW9ERQ62M3wEjVtPMiEvUC2b+mn6eFuTqiM= |
| Backup (CA) | *.replit.dev | sha256/jQJTbIh0grw0/1TkHSumWb+Fs0Ggogr621gT3PvPKG0= |
| Backup (CA) | *.replit.app | sha256/jQJTbIh0grw0/1TkHSumWb+Fs0Ggogr621gT3PvPKG0= |

**Arquivos Modificados:**
- `NetworkConfig.kt`: BASE_URL atualizado para `https://picard.replit.dev/`
- `NetworkConfig.kt`: CERTIFICATE_PINS com pins reais do servidor
- `CertificatePinningManager.kt`: Habilitado certificate pinning (removido bypass)
